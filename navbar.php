		...
		<div class="sidebar-list">
			<div  id="sidebar-menu" class="sidebar-inner">
                <ul class="p-0">
                    ...
                    <a href="index.php?page=water" class="nav-item nav-water">
    <span class='icon-field'><i data-feather="droplet"></i></span> Water</a>
					...
					<?php endif; ?>
					<a href="https://melbur.co.ke" class="nav-item" target="_blank"><span class='icon-field'> <i data-feather="film"></i></span> About Developer</a>

<a href="https://studios.melbur.co.ke" class="nav-item" target="_blank"><span class='icon-field'> <i data-feather="gift"></i></span> More Project</a>
