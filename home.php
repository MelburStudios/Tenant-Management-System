...
Welcome to your Tenant's Management System</div>
<hr>
               <div class="row">
                        ...
                        <div class="card-body card-1 bg-info p-0">
                           <div class="card-body text-white py-4">
                              <div class="d-flex flex-row">
                                 <div class="col-3 align-self-center">
                                    <div class="round">
                                       <span class="float-right summary_icon"> <i class="fa fa-tint"></i></span>
                                    </div>
                                 </div>
                                 <div class="col-9 align-self-center text-right">
                                    <div class="m-l-10">
                                       <h3 class="text1">
   <?php 
   $water_units = $conn->query("SELECT SUM(units_used) as total FROM water_readings");
   echo $water_units->num_rows > 0 ? number_format($water_units->fetch_array()['total']) : 0;
   ?>
</h3>
<p>Water Units Consumed</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
   ...
   echo $total->num_rows > 0 ? number_format($total->fetch_array()['total'],2) : 0;
   ?>
</h3>
<p>Total Monies Collected</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
